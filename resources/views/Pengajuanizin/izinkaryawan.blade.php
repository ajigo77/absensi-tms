...
<body class="flex flex-col h-screen">
    ...
    <div class="flex-grow mx-auto bg-white p-6 shadow-lg w-full overflow-auto">
        <h1 class="text-2xl font-bold text-center mb-6">Form Izin Karyawan</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-1">
                    ...
                    <select class="border rounded w-full p-2" required>
                        ...
                        <option value="pulang_awal">Izin pulang lebih awal</option>
                        <option value="datang_terlambat">Izin datang terlambat</option>
                    </select>

                    <label class="block mb-2 mt-4">Jam Pulang Awal:</label>
                    <input type="time" class="border rounded w-full p-2" required>

                    <label class="block mb-2 mt-4">Tanggal Izin:</label>
                    <input type="date" class="border rounded w-full p-2" required>
                </div>

                <!-- Bagian 3: Alasan -->
                <div class="md:col-span-1">
                    <h2 class="text-lg font-semibold mb-10">Alasan:</h2>
