            ...
            <nav class="mt-2"> <!--begin::Sidebar Menu-->
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="../UI/general.html" class="nav-link active"> <i
                                        class="nav-icon bi bi-circle"></i>
                                    <p>General</p>
                                </a> </li>
                    ...
                    <li class="nav-item"> <a href="#" class="nav-link"> <i
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="../forms/general.html" class="nav-link active"> <i
                                        class="nav-icon bi bi-circle"></i>
        ...
        <div class="app-content"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Row-->
                <div class="row g-4"> <!--begin::Col-->
                    ...
                    <div class="col-md-6"> <!--begin::Accordion-->
                        ...
                        <div class="card card-warning card-outline mb-4"> <!--begin::Header-->
                            ...
                            <div class="card-body">
                                <h1>
                                    Example heading <span class="badge bg-secondary">New</span> </h1>
                                <h2>
                                    Example heading <span class="badge bg-secondary">New</span> </h2>
                                <h3>
                                    Example heading <span class="badge bg-secondary">New</span> </h3>
                                <h4>
                                    Example heading <span class="badge bg-secondary">New</span> </h4>
                                <h5>
                                    Example heading <span class="badge bg-secondary">New</span> </h5>
                                <h6>
                                    Example heading <span class="badge bg-secondary">New</span> </h6>
                                <hr> <button type="button" class="btn btn-primary">
                                    Notifications <span class="badge text-bg-secondary">4</span> </button>
                                <hr> <button type="button" class="btn btn-primary position-relative">
                                    Inbox
                                    <span
                                ...
                                <hr> <button type="button" class="btn btn-primary position-relative">
                                    ...
                                    <span
                                        ...
                                        <span class="visually-hidden">New alerts</span> </span> </button>
                                <hr> <span class="badge text-bg-primary">Primary</span> <span
                                    class="badge text-bg-secondary">Secondary</span> <span
                                    class="badge text-bg-success">Success</span> <span
                                    class="badge text-bg-danger">Danger</span> <span
                                    class="badge text-bg-warning">Warning</span> <span
                                    class="badge text-bg-info">Info</span> <span
                                    class="badge text-bg-light">Light</span> <span
                                    class="badge text-bg-dark">Dark</span>
                                <hr> <span class="badge rounded-pill text-bg-primary">Primary</span> <span
                        ...
                        <div class="card card-danger card-outline mb-4"> <!--begin::Header-->
                            ...
                            <div class="card-body"> <button type="button"
                                    class="btn btn-primary mb-2">Primary</button> <button type="button"
                                    class="btn btn-secondary mb-2">Secondary</button> <button type="button"
                                    class="btn btn-success mb-2">Success</button> <button type="button"
                                    class="btn btn-danger mb-2">Danger</button> <button type="button"
                                    class="btn btn-warning mb-2">Warning</button> <button type="button"
                                    class="btn btn-info mb-2">Info</button> <button type="button"
                                    class="btn btn-light mb-2">Light</button> <button type="button"
                                    class="btn btn-dark mb-2">Dark</button> <button type="button"
                                    class="btn btn-link mb-2">Link</button>
                                <hr> <button type="button" class="btn btn-primary mb-2" disabled>Primary
                                    (disabled)</button> <button type="button" class="btn btn-secondary mb-2"
                                    disabled>Secondary (disabled)</button> <button type="button"
                                    class="btn btn-success mb-2" disabled>Success (disabled)</button> <button
                                    type="button" class="btn btn-danger mb-2" disabled>Danger (disabled)</button>
                                <button type="button" class="btn btn-warning mb-2" disabled>Warning
                                    (disabled)</button> <button type="button" class="btn btn-info mb-2" disabled>Info
                                    (disabled)</button>
                                <hr> <button type="button" class="btn btn-outline-primary mb-2">Primary</button>
                                <button type="button" class="btn btn-outline-secondary mb-2">Secondary</button>
                                <button type="button" class="btn btn-outline-success mb-2">Success</button> <button
                                    type="button" class="btn btn-outline-danger mb-2">Danger</button> <button
                                    type="button" class="btn btn-outline-warning mb-2">Warning</button> <button
                                    type="button" class="btn btn-outline-info mb-2">Info</button> <button
                                    type="button" class="btn btn-outline-light mb-2">Light</button> <button
                                    type="button" class="btn btn-outline-dark mb-2">Dark</button>
                                <hr> <button type="button" class="btn btn-primary btn-lg">Large button</button>
                                <button type="button" class="btn btn-warning btn-sm">Small button</button> <button
                    ...
                    <div class="col-md-6"> <!--begin::Button Group-->
                        <div class="card card-info card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                                <div class="card-title">Button Group</div>
                            </div> <!--end::Header--> <!--begin::Body-->
                            <div class="card-body">
                                <div class="btn-group mb-2" role="group" aria-label="Basic example"> <button
                                        type="button" class="btn btn-primary">Left</button> <button type="button"
                                        class="btn btn-primary">Middle</button> <button type="button"
                                        class="btn btn-primary">Right</button> </div>
                                <div class="btn-group mb-2" role="group" aria-label="Basic mixed styles example">
                                    <button type="button" class="btn btn-danger">Left</button> <button
                                        type="button" class="btn btn-warning">Middle</button> <button type="button"
                                        class="btn btn-success">Right</button> </div>
                                <div class="btn-group mb-2" role="group" aria-label="Basic outlined example">
                                    <button type="button" class="btn btn-outline-primary">Left</button> <button
                                        type="button" class="btn btn-outline-primary">Middle</button> <button
                                        type="button" class="btn btn-outline-primary">Right</button> </div>
                                <hr>
                                <div class="btn-group mb-2" role="group"
                                    aria-label="Basic checkbox toggle button group"> <input type="checkbox"
                                        class="btn-check" id="btncheck1" autocomplete="off"> <label
                                        class="btn btn-outline-primary" for="btncheck1">Checkbox 1</label> <input
                                        type="checkbox" class="btn-check" id="btncheck2" autocomplete="off"> <label
                                        class="btn btn-outline-primary" for="btncheck2">Checkbox 2</label> <input
                                        type="checkbox" class="btn-check" id="btncheck3" autocomplete="off"> <label
                                ...
                                <div class="btn-group mb-2" role="group"
                                    ...
                                    <label class="btn btn-outline-primary" for="btnradio1">Radio 1</label> <input
                                        ...
                                        for="btnradio2">Radio 2</label> <input type="radio" class="btn-check"
                        ...
                        </div> <!--end::Button Group--> <!--begin::Collapse-->
                        <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                                <div class="card-title">Collapse</div>
                            </div> <!--end::Header--> <!--begin::Body-->
                            <div class="card-body">
                                <p class="d-inline-flex gap-1"> <a class="btn btn-primary" data-bs-toggle="collapse"
                                        href="#collapseExample" role="button" aria-expanded="false"
                                        aria-controls="collapseExample">
                                        Link with href
                                    </a> <button class="btn btn-success" type="button" data-bs-toggle="collapse"
                        ...
                        </div> <!--end::Collapse--> <!--begin::Dropdowns-->
                        <div class="card card-success card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="btn-group"> <button type="button" class="btn btn-danger">Danger
                                ...
                                <div class="btn-group"> <button type="button" class="btn btn-warning">Warning
                                        Split</button> <button type="button"
                        ...
                        </div> <!--end::Dropdowns--> <!--begin::List Group-->
                        <div class="card card-warning card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="list-group"> <a href="#"
                                    ...
                                    </a> <a href="#" class="list-group-item list-group-item-action">A second
                                        link item</a> <a href="#"
                                        ...
                                        aria-disabled="true">A disabled link item</a> </div>
                            </div> <!--end::Body-->
                        </div> <!--end::List Group--> <!--begin::Navbar-->
                        <div class="card card-danger card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                                ...
                                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                                    <div class="container-fluid"> <a class="navbar-brand" href="#">Navbar</a>
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            ...
                                            <form class="d-flex" role="search"> <input class="form-control me-2"
                        ...
                        </div> <!--end::Navbar--> <!--begin::Pagination-->
                        <div class="card card-info card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                        ...
                        </div> <!--end::Pagination--> <!--begin::Placeholder-->
                        <div class="card card-secondary card-outline mb-4"> <!--begin::Header-->
                            ...
                            <div class="card-body">
                                <div class="card" aria-hidden="true">
                                    <div class="card-body">
                                        <h5 class="card-title placeholder-glow"> <span
                                                class="placeholder col-6"></span> </h5>
                                        <p class="card-text placeholder-glow"> <span class="placeholder col-7"></span>
                                            <span class="placeholder col-4"></span> <span
                                                ...
                                                class="placeholder col-8"></span> </p>
                                    </div>
                                </div>
                            </div> <!--end::Body-->
                        </div> <!--end::Placeholder--> <!--begin::Progress-->
                        <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                        ...
                        </div> <!--end::Progress--> <!--begin::Toast-->
                        <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
                                <div class="card-title">Toast</div>
                            </div> <!--end::Header--> <!--begin::Body-->
                            <div class="card-body"> <button type="button" class="btn btn-primary mb-2"
                                    data-bs-toggle="toast" data-bs-target="toastDefault">Show default toast</button>
                                <hr> <button type="button" class="btn btn-primary mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastPrimary">Show primary toast</button> <button type="button"
                                    class="btn btn-secondary mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastSecondary">Show secondary toast</button> <button
                                    type="button" class="btn btn-success mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastSuccess">Show success toast</button> <button type="button"
                                    class="btn btn-danger mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastDanger">Show danger toast</button> <button type="button"
                                    class="btn btn-warning mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastWarning">Show warning toast</button> <button type="button"
                                    class="btn btn-info mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastInfo">Show info toast</button> <button type="button"
                                    class="btn btn-light mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastLight">Show light toast</button> <button type="button"
                                    class="btn btn-dark mb-2" data-bs-toggle="toast"
                                    data-bs-target="toastDark">Show dark toast</button>
                                <div class="toast-container position-fixed bottom-0 end-0 p-3">
                                    <div id="toastDefault" class="toast" role="alert" aria-live="assertive"
                                        aria-atomic="true">
                                        <div class="toast-header"> <i class="bi bi-circle me-2"></i> <strong
                                                class="me-auto">Bootstrap</strong> <small>11 mins ago</small> <button
                            ...
                            <div class="card-body">
                                <p class="muted">
                                    Placeholder text to demonstrate some <a href="#" data-bs-toggle="tooltip"
                                        data-bs-title="Default tooltip">inline links</a> with tooltips. This is now
                                    just filler, no killer.
                                    Content placed here just to mimic the presence of <a href="#"
                                        data-bs-toggle="tooltip" data-bs-title="Another tooltip">real text</a>. And
                                    all that just to give you an idea of how tooltips
                                    ...
                                    practice, once you use them on <a href="#" data-bs-toggle="tooltip"
                                        data-bs-title="The last tip!">your own</a> site or project.
                                </p>
                            </div> <!--end::Body-->
                        </div> <!--end::Toast--> <!--begin::Spinner-->
                        <div class="card card-success card-outline mb-4"> <!--begin::Header-->
                            <div class="card-header">
