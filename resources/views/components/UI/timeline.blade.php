                ...
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item"> <a href="../UI/timeline.html" class="nav-link active"> <i
                                        class="nav-icon bi bi-circle"></i>
                                    <p>Timeline</p>
                                </a> </li>
                        </ul>
                        ...
                        <div class="timeline"> <!-- timeline time label -->
                            ...
                            <div> <i class="timeline-icon bi bi-envelope text-bg-primary"></i>
                                <div class="timeline-item"> <span class="time"> <i class="bi bi-clock-fill"></i>
                                    ...
                                    <div class="timeline-footer"> <a class="btn btn-primary btn-sm">Read more</a> <a
                            ...
                            <div> <i class="timeline-icon bi bi-person text-bg-success"></i>
                                <div class="timeline-item"> <span class="time"> <i class="bi bi-clock-fill"></i> 5
                                        mins ago
                                    </span>
                            ...
                            <div> <i class="timeline-icon bi bi-chat-text-fill text-bg-warning"></i>
                                <div class="timeline-item"> <span class="time"> <i class="bi bi-clock-fill"></i> 27
                                        mins ago
                                    </span>
                                    ...
                                    <div class="timeline-footer"> <a class="btn btn-warning btn-sm">View comment</a>
                                    </div>
                                </div>
                            ...
                            <div> <i class="timeline-icon bi bi-camera text-bg-primary"></i>
                                <div class="timeline-item"> <span class="time"> <i class="bi bi-clock-fill"></i> 2
                                        days ago
                                    </span>
                                    <h3 class="timeline-header"> <a href="#">Mina Lee</a> uploaded new photos
                                    </h3>
                                    <div class="timeline-body"> <img src="../../../dist/assets/img/user1-128x128.jpg"
                                            alt="..."> <img src="../../../dist/assets/img/user1-128x128.jpg"
                                            alt="..."> <img src="../../../dist/assets/img/user1-128x128.jpg"
                                            alt="..."> <img src="../../../dist/assets/img/user1-128x128.jpg"
                                            alt="..."> </div>
                                </div>
