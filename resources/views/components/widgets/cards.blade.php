                ...
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item"> <a href="../widgets/cards.html" class="nav-link active"> <i
                                        class="nav-icon bi bi-circle"></i>
                                    <p>Cards</p>
                                </a> </li>
                        </ul>
    ...
    <main class="app-main"> <!--begin::App Content Header-->
        ...
        <div class="app-content"> <!--begin::Container-->
            <div class="container-fluid">
                ...
                <h5 class="mb-2">Abilities</h5> <!--begin::Row-->
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools"> <button type="button" class="btn btn-tool"
                                        data-lte-toggle="card-collapse"> <i data-lte-icon="expand"
                                            ...
                                            class="bi bi-dash-lg"></i> </button> </div> <!-- /.card-tools -->
                            </div> <!-- /.card-header -->
                            <div class="card-body">The body of the card</div> <!-- /.card-body -->
                        </div> <!-- /.card -->
                    </div> <!-- /.col -->
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="card card-danger">
                            <div class="card-header">
                                ...
                                <div class="card-tools"> <button type="button" class="btn btn-tool"
                                        data-lte-toggle="card-maximize"> <i data-lte-icon="maximize"
                                            class="bi bi-fullscreen"></i> <i data-lte-icon="minimize"
                                            class="bi bi-fullscreen-exit"></i> </button> </div> <!-- /.card-tools -->
                            </div> <!-- /.card-header -->
                            <div class="card-body">The body of the card</div> <!-- /.card-body -->
                        </div> <!-- /.card -->
                    </div> <!-- /.col -->
                </div> <!--end::Row-->
                <h5 class="mb-2">Card Outlined</h5> <!--begin::Row-->
                <div class="row g-4 mb-4">
                    <div class="col-md-3">
                ...
                <h5 class="mb-2">Card with <code>.text-bg-*</code></h5> <!--begin::Row-->
                <div class="row g-4 mb-4">
                    <div class="col-md-3">
